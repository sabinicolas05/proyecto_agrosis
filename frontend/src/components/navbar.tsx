...
const menuItems = [
  ...
  { 
    ...
    icon: <FaDollarSign />,
    subItems: [
      { id: 18, label: "Pagos", path: "/finanzas/pagos", icon: <FaSeedling /> },
      { id: 19, label: "Produccion", path: "/finanzas/produccion", icon: <FaTachometerAlt /> },
      { id: 20, label: "Residuos", path: "/finanzas/residuos", icon: <FaTree /> },
      { id: 21, label: "Venta", path: "/finanzas/venta", icon: <FaTree /> },
